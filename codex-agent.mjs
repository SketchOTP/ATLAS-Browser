...
export const atlasDynamicTools = [
  ...
  { type: 'function', name: 'atlas_read_resource', description: 'Read one exact library resource inside the allowed project. Text returns complete text, PDFs return locally extracted page text, pictures are supplied as image content, and linked downloads are authorized by project and resource without exposing or listing the Downloads folder.', inputSchema: { type: 'object', required: ['projectId', 'resourceId'], properties: { projectId: projectIdSchema, resourceId: textSchema }, additionalProperties: false } },
